...
PERSISTENT_CHROME = """  <div class="bg-hover-layer" aria-hidden="true"></div>
  ...
  <div id="site-menu" class="site-menu" role="dialog" aria-modal="true" aria-label="Navigation menu" aria-hidden="true" data-nav-menu>
    ...
    <nav class="menu-nav" aria-label="Primary menu">
      <p class="menu-nav-text">
        <a href="/" class="menu-nav-link" data-menu-home data-nav="home">HOME</a><span class="menu-nav-sep" data-sep-after="home"> / </span><a href="/about" class="menu-nav-link" data-menu-about data-nav="about">ABOUT</a><span class="menu-nav-sep is-inactive"> / </span><span class="menu-nav-link is-inactive" aria-disabled="true">SHOP</span><span class="menu-nav-sep is-inactive"> / </span><span class="menu-nav-link is-inactive" aria-disabled="true">EXPERIMENTS</span>
      </p>
    </nav>
